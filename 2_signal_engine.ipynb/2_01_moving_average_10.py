...
#In this code, the objective is to create the first 10-day moving average using "clean data"
...
#This code uses the cleaned gold price data from Clean_Data and calculates a 10-day moving average of the closing prices. 
#It adds this as a new column, allowing us to detect potential buy/sell signals
